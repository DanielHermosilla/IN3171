---
title: "Programa, unidades y capítulos guía"
---

## Unidades oficiales del programa

1. Modelación de problemas de optimización.
2. Modelación con problemas lineales enteros.
3. Geometría de poliedros y método Simplex.
4. Dualidad y sensibilidad de soluciones óptimas.
5. Programación entera.
6. Elementos de optimización no lineal.

## Estructura adoptada en estas notas
...
## Capítulos del libro usados en el curso

Según el programa:

- Unidad 1: capítulos 1 y 7.
- Unidad 2: técnicas de modelación (apoyo en material complementario y práctica).
- Unidad 3: capítulo 2 (geometría) y capítulo 3 (Simplex).
- Unidad 4: capítulos 4 y 5.
- Unidad 5 (entera): capítulo 11 (más formulaciones de capítulo 10 en apoyo).
- Unidad 6 (no lineal): convexidad/dualidad/KKT con apoyo de capítulos 3, 4, 5 y 8, más bibliografía adicional.
<!---->
