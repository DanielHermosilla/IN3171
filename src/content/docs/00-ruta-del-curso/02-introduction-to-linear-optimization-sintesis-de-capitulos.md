---
title: "Introduction to Linear Optimization - síntesis de capítulos"
---

Se utiliza como base el libro *Introduction to Linear Optimization* de *Dimitris Bertsimas*. El libro puede volverse complicado, por lo mismo, se deja una guía de cómo utilizar el libro.

## Estructura global del texto

El texto está organizado por capítulos que separan claramente:

1. Formulación y fundamentos de PL.
2. Geometría de poliedros.
3. Método Simplex.
4. Dualidad.
5. Sensibilidad.
6. Optimización a gran escala.
7. Redes.
8. Complejidad y elipsoide.
9. Métodos de punto interior.
10. Formulaciones enteras.
11. Métodos de programación entera.
12. Estudios de caso.

## Capítulos más usados en el curso 
...
- Poliedros y convexidad.
- Puntos extremos y vértices.
...
- Condiciones de optimalidad para bases.
- Desarrollo algebraico del Simplex.
- Implementaciones de pivoteo.
...
- Dual de PL y teoremas de dualidad.
